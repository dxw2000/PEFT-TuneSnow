...
class Table3_Baseline_MSPM_DARM_Finetune_Adapter(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Table3_Baseline_MSPM_DARM_Finetune_Adapter, self).__init__()
        self.patch_size = patch_size
...
# EXP2
# model = Table3_Baseline_MSPM_DARM_Finetune_Adapter().cuda()
