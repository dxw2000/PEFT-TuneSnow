...
class Baseline_MSPM_DARM_Finetune_Adapter_LoRA_RelPos(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Baseline_MSPM_DARM_Finetune_Adapter_LoRA_RelPos, self).__init__()
        self.patch_size = patch_size
...
# model = Baseline_MSPM_DARM_Finetune_Adapter_LoRA_RelPos().cuda()
