...
# from exp_SAM_desnow.MLPAdapter_segment_anything.modeling.common import LayerNorm2d
# from exp_SAM_desnow.MLPAdapter_segment_anything import sam_model_registry

from ..base_net_snow import *
from ..MLPAdapter_segment_anything.modeling.common import LayerNorm2d
from ..MLPAdapter_segment_anything import sam_model_registry
...
class Table3_Baseline_MSPM_DARM_Finetune_MLPAdapter(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Table3_Baseline_MSPM_DARM_Finetune_MLPAdapter, self).__init__()
        self.patch_size = patch_size
...
# EXP2
# model = Table3_Baseline_MSPM_DARM_Finetune_MLPAdapter().cuda()
