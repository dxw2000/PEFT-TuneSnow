...
from exp_SAM_desnow.segment_anything.modeling.common import LayerNorm2d
from exp_SAM_desnow.segment_anything import sam_model_registry
...
class Table3_Baseline_MSPM_DARM_Finetune_LoRA(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Table3_Baseline_MSPM_DARM_Finetune_LoRA, self).__init__()
        self.patch_size = patch_size
...
# EXP2
# model = Table3_Baseline_MSPM_DARM_Finetune_LoRA().cuda()
