...
class Table2_Baseline_NoFinetune_MSPM_DARM(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Table2_Baseline_NoFinetune_MSPM_DARM, self).__init__()
        self.patch_size = patch_size
...
# EXP2
# model = Table2_Baseline_NoFinetune_MSPM_DARM().cuda()
