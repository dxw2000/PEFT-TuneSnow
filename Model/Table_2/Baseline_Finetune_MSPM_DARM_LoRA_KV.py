...
class SAM_Image_Encoder(nn.Module):
    def __init__(self, model_name, image_size, checkpoint, num_classes=2):
        ...
        for t_layer_i, blk in enumerate(sam.image_encoder.blocks):
            ...
            w_a_linear_k = nn.Linear(self.dim, 4, bias=False)
            w_b_linear_k = nn.Linear(4, self.dim, bias=False)
...
class Baseline_Finetune_MSPM_DARM_KV(nn.Module):
    def __init__(self,
    in_channels=3,
    out_cahnnels=3,
    ...
    SAM_image_size = 256,
        ...
        super(Baseline_Finetune_MSPM_DARM_KV, self).__init__()
        self.patch_size = patch_size
...
# model = Baseline_Finetune_MSPM_DARM_KV().cuda()
