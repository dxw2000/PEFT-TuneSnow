...
class Table2_Baseline_NoFinetune_MSPM(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Table2_Baseline_NoFinetune_MSPM, self).__init__()
        self.patch_size = patch_size
    ...
    def forward(self, x):
        ...
        sam_x = x
        # sam_x = self.conv(x)
        # print("sam_x:", sam_x.shape)
        # print("ok")
        # sam_x = F.upsample(sam_x, (128, 128), mode="bicubic")
        # print("sam_x:", sam_x.shape)
        # print("ok")
        # 使用SAM-IMAGE-Encoder
        ...
        # out_dec_level0_refine = self.refinement(out_dec_level0, cnn_encoder_item, wavevit_encoder_item)
...
# EXP2
# model = Table2_Baseline_NoFinetune_MSPM().cuda()
