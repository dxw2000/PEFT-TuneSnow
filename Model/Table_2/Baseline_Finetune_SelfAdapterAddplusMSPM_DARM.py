...
class Baseline_Finetune_SelfAdapterAddplusMSPM_DARM(nn.Module):
    def __init__(self,
    in_channels=3,
    out_cahnnels=3,
    ...
    SAM_image_size = 256,
        ...
        super(Baseline_Finetune_SelfAdapterAddplusMSPM_DARM, self).__init__()
        self.patch_size = patch_size
    ...
    def forward(self,x):
        ...
        # ratio_rate = 0.25
        SelfAdapter_Feature = x_0_1 + x_2_3_4 + x_5_6_7 + x_8_9_10_11
...
#
# model = Baseline_Finetune_SelfAdapterAddplusMSPM_DARM().cuda()
