...
class Baseline_Finetune_SelfAdapterAddMSPM_DARM(nn.Module):
    def __init__(self,
    in_channels=3,
    out_cahnnels=3,
    ...
    SAM_image_size = 256,
        ...
        super(Baseline_Finetune_SelfAdapterAddMSPM_DARM, self).__init__()
        self.patch_size = patch_size
...
#
# model = Baseline_Finetune_SelfAdapterAddMSPM_DARM().cuda()
