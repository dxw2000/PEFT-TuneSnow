...
class Table2_Baseline_NoFinetune(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Table2_Baseline_NoFinetune, self).__init__()
        self.patch_size = patch_size
    ...
    def forward(self, x):
        ...
        # print("ok")
        # 使用SAM-IMAGE-Encoder
        x_out = self.SAM_Image_Encoder(sam_x)
        # print("x_0_1:", x_0_1.shape)
        # print("ok")
        # print("x_2_3_4:", x_2_3_4.shape)
        # print("x_5_6_7:", x_5_6_7.shape)
        # print("x_8_9_10_11:", x_8_9_10_11.shape)
        # print("ok")
        # print("SAM_out:", SAM_out.shape)
        # print("ok")
        # print("")
        # print("SAM_out:", SAM_out.shape)
        # print("ok")
        ...
        # print("out_enc_level4:", out_enc_level4.shape)
        # print("ok")
        # SAM_out = F.upsample(x_out, (out_enc_level4.shape[2], out_enc_level4.shape[3]), mode="bicubic")
        # print("SAM_out:", SAM_out.shape)
        # print("ok")
...
# EXP2
# model = Table2_Baseline_NoFinetune().cuda()
