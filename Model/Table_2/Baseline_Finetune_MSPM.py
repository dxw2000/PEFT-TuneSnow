...
class Baseline_Finetune_MSPM(nn.Module):
    def __init__(self,
                 in_channels=3,
                 out_cahnnels=3,
        ...
        super(Baseline_Finetune_MSPM, self).__init__()
        self.patch_size = patch_size
    ...
    def forward(self, x):
        ...
        # _, _, _, _, x_out = self.SAM_Image_Encoder(sam_x)
        ...
        out_dec_level1 = self.out2(out_dec_level0) + x
...
# model = Baseline_Finetune_MSPM().cuda()
